...
const colorPairs = [
    ...
    { threshold: 0.90, value: 0xbf2a42 },
    { threshold: 0.85, value: 0xff6347 },
    { threshold: 0.80, value: 0x59b0f4 },
    { threshold: 0.70, value: 0x3cb371 },
...
export default function getAccuracyColor(accuracy: number): number {
    ...
    console.warn("getAccuracyColor: no color pairs defined, defaulting to 0x000000");
    return 0x000000;
}