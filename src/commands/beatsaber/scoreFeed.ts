    ...
    data: new SlashCommandBuilder()
            ...
            subcommand
                ...
                .addStringOption((option) =>
                    option
                        ...
                        .setDescription(
                            "Select how you want scores to be displayed"
                        )
                        .setRequired(true)
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("unlink")
                .setDescription(
                    "Remove a BeatLeader profile from the score feed"
                )
                .addStringOption((option) =>
                    option
                        .setName("id")
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("request")
                .setDescription(
                    "Request your profile to be added to the score feed"
                )
        ),
        ...
        switch (interaction.options.getSubcommand()) {
            ...
            case "link": {
                ...
                if (feed.beatleaderIds.includes(beatleaderId)) {
                    await interaction.reply({
                        content:
                            "This player is already linked to the score feed!",
                        ephemeral: true,
                    });
                    return;
                }
            ...
            case "request": {
                ...
                switch (feed.requestType) {
                    ...
                    case "open": {
                        ...
                        return await interaction.reply({
                            content:
                                "Your profile has been added to the score feed!",
                            ephemeral: true,
                        });
                    }
                }
